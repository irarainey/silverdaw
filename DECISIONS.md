...
| D-0021 | `IMPORTANT` | Scratch Editor action patterns (Amendment 1: backing accompaniment monitor; Amendment 2: backing durations + monitor trims; Amendment 3: keyboard crossfader cut + library-item authoring) | `docs/adr/0021-scratch-editor-action-patterns.md` |
