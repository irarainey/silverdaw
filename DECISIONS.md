...
| D-0028 | `IMPORTANT` | Tempo detection conditions audio with a zero-phase percussive emphasis before beat tracking, and settles a disputed period refinement with an independent second engine consulted only on dispute | `docs/adr/0028-tempo-detection-conditioning-and-arbiter.md` |
