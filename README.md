...
| **Right-click on a clip** | Open the context menu: **Delete**, **Duplicate**, **Split at playhead**, an inline 16-swatch **Colour** picker, **Save clip to library**, **Save as sample…**, **Warp…** for BPM/time-stretch controls, and **Pitch** for semitone/cents tuning. Shows **Relink…** at the top when the clip is unresolved. |
