  ...
  async load(): Promise<void> {
    ...
    try {
      ...
      this.prefs = {
        ...
        latencyCalibrations: sanitiseLatencyCalibrations(parsed.latencyCalibrations),
        ...
        scratchRealism: sanitiseScratchRealismPrefs(parsed.scratchRealism, defaults.scratchRealism),
