...
declare global {
  ...
  interface Window {
    silverdaw: {
      ...
      chooseMixdownSaveAs(defaultPath: string, format: 'wav' | 'mp3' | 'flac' | 'aiff' | 'ogg-vorbis'): Promise<string | null>
      resolveMixdownDefaultPath(projectFilePath: string | null, projectName: string, format: 'wav' | 'mp3' | 'flac' | 'aiff' | 'ogg-vorbis'): Promise<string>
