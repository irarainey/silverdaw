---
agent: agent
description: "Full-codebase review of the Jackdaw monorepo (C++/JUCE backend + TypeScript/Vue 3 Electron frontend) against project, language, and security standards."
---

# Codebase Review — Jackdaw (C++/JUCE backend + TS/Vue 3 frontend)
...
- **Backend** (`backend/`): headless JUCE 8.0.12 audio engine + IXWebSocket bridge, C++17, CMake 3.22+, MSVC on Windows. Single executable `JackdawBackend.exe`.
