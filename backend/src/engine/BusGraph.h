...
private:
    ...
    // Samples this track's automation curves at `subStartSamples`. Cursor state is
    // audio-thread-owned; message-thread changes publish only a pointer or reset request.
