...
const juce::Identifier ProjectState::kViewFxTab{"viewFxTab"};
...
const juce::Identifier ProjectState::kClipEditorMetronomeEnabled{"clipEditorMetronomeEnabled"};
...
const juce::Identifier ProjectState::kRecordingOrigin{"recordingOrigin"};
